...
class BudgetTransfer:
    ...
    def add_transfer(self, sender_id: int, receiver_id: int, amount: Decimal, 
        description: str, created_on: date) -> Transfer:
        new_transfer = Transfer(id = 0, sender_id = sender_id, 
    ...
    def get_by_account(self, account_id: int) -> list[Transfer]: 
        ...
        account_transfers = [transfer for transfer in transfers 
