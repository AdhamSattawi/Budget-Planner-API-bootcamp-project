...
- **BONUS** - **Part 3** — Design the equivalent relational database schema and write the SQL queries the application would use.
...
**Transactions**
10. **BONUS** View all transactions, with optional filtering by account and by month/year
...
**Summaries & Reports**
17. **BONUS** View a monthly summary: total income, total expenses, and net cash flow for a given month
18. View spending breakdown by category for a given month

**Data Portability**
19. **BONUS** Export all data to a zip file
20. **BONUS** Import data from a zip file (with validation)

**Dashboard**
21. **BONUS** View a dashboard summary showing: Net Worth, this month's total income, this month's total expenses, and this month's net cash flow
